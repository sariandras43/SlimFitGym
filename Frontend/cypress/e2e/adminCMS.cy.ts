describe('Admin CMS - Passes Management', () => {
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle concurrent deletions', () => {
      ...
      cy.get('.toggle-slider').click();
      cy.get('tr.deleted').should('have.length', 2);
    });
...
describe('Admin CMS - User Management', () => {
  const seededUsers = [
    ...
    {
      name: 'Horváth Vivien',
      email: 'vivien.horvath@gmail.com',
      role: 'user',
      phone: '+36301234507',
      hungarianRole: 'Felhasználó',
    },
    ...
    {
      name: 'Szilágyi Anna',
      email: 'anna.szilagyi@gmail.com',
      role: 'user',
      phone: '+36301234509',
      hungarianRole: 'Felhasználó',
    },
    {
      name: 'Balogh Gabriella',
      email: 'gabriella.balogh@gmail.com',
      role: 'user',
      phone: '+36301234510',
      hungarianRole: 'Felhasználó',
    }
  ...
  describe('Search Functionality', () => {
    ...
    it('should search by role translation', () => {
      ...
      cy.get('tr:not(.deleted)').should('have.length', 7); 
    });
  });
});
...
describe('Admin CMS - Machines Management', () => {
  const seededMachines = [
    { name: 'Bicikli', description: "Egyszerű bicikli" },
    { name: 'Futópad', description: "Sima futópad" },
    { name: 'Elliptikus tréner', description: "Profi gépezet" },
  ...
  describe('Search Functionality', () => {
    it('should filter by machine name substring', () => {
      ...
      cy.get('[data-cell="Név"]').should('have.length', 6); // Evezőgép, Lépcsőzőgép, Mellprés gép, Hasprés gép, Hátlehúzó gép, Eliptikus tréner: Profi GÉPezet 
    });
